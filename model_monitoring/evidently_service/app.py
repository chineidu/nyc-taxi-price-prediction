...
Metrics 
calculation results are available with `GET /metrics` HTTP method in Prometheus compatible format.

Copied!
source: https://github.com/DataTalksClub/mlops-zoomcamp/blob/main/05-monitoring/evidently_service/app.py
"""
...
def configure_service():
    ...
    if not os.path.exists(config_file_path):
        logging.error(f"File {config_file_path} does not exist")
        exit(
